    ...
    sidebarMenu(
      ...
      tags$div("Introduction",
               style= "font-size: 1.5em;
                 ...
                 color: orange"),
      menuItem("Introduction", tabName = "welcome1", icon = icon("house"), selected = T),
      ...
      menuItem("Meta-analysis", icon=icon("sliders"),
               menuSubItem("Meta-analysis",tabName = "meta",icon=NULL)),
      ...
      tags$div("Source",
               style= "margin-top: 6px;
                         ...
                         background: rgba(255, 255, 255, 0);
                        color: yellow"),
      menuItem("source", icon=icon("sourcetree"),
      menuSubItem("Dataset source", href = "https://liuxiaoping2020.github.io/CBioProfilerDatasource/",icon=icon("server")),
      menuSubItem("CBioProfiler standalone app", href = "https://gitee.com/liuxiaoping2020/CBioProfiler",icon=icon("toolbox")),
      menuSubItem("R package reference", href = "https://liuxiaoping2020.github.io/CBioProfiler_reference/",icon=icon("book-open"))
      ),
      ...
      tags$div("Tutorial",
               style= "margin-top: 6px;
                         ...
                         background: rgba(255, 255, 255, 0);
                        color: deepskyblue"),
      menuItem("Tutorial", icon=icon("magnifying-glass"),
      menuSubItem("Document tutorial" , href = "https://github.com/liuxiaoping2020/CBioProfiler_tutorial/blob/main/CBioProfiler_tutorial.pdf", icon = icon("book")),
      menuSubItem("Video tutorial" , href = "https://www.bilibili.com/read/cv27807742/?jump_opus=1", icon = icon("video"))
      ),
...
tags$div("Zisong Wang",
      ...
      tags$div("Email: zisong.wang@whu.edu.cn",
               style= "margin-top: 6px;
                           font-size: 1em;
                           padding: 0 1.25em;
                           text-align: left;
...
body <-  dashboardBody(
  ...
  tabItems(
    ...
    source(file.path(ui.path, "meta.R"),local=T)$value,
