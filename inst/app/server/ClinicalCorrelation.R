...
observeEvent(input$table1bt, {
  ...
  updateCollapse(session, "collapseclinical", open = "Table for the correlations between gene expression and clinical features", close = "Descriptions and parameters")
