  ...
  fluidRow(
                                             ...
                                             tabPanel("Immune checkpoint plot", align="center",
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "ICBplot_wrapper",
                                                                                 splitLayout(
                                                                                   numericInput("ICBpltwidth","Figure width",value = 10),
                                                                                   numericInput("ICBpltheight","Figure height",value = 10)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("ICBwidth", "Plot Width (%)", min = 0, max = 100, value = 80),
          sliderInput("ICBheight", "Plot Height (px)", min = 0, max = 1000, value = 800)
      ),
      actionButton("ICBbt",
                   "Submit",
