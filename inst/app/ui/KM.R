     ...
     fluidRow(column(4,align="left",
                     ...
                     hidden(div(id = "km_wrapper",
                                 ...
                                 splitLayout(
                                            ...
                                            numericInput("kmwidth","Figure width",value = 5),
                                            numericInput("kmheight","Figure height",value = 5)),
        ...
        column(3,box(
          ...
          sliderInput("survwidth", "Plot Width (%)", min = 0, max = 100, value =40),
          sliderInput("survheight", "Plot Height (px)", min = 0, max = 1200, value =400),
