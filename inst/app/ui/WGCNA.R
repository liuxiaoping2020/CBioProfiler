tabItem(
  ...
  fluidPage(
    column(9,
           ...
           bsCollapse(id = "collapseWGCNApreprocess", open = "Descriptions and parameters for data preprocessing",
                      bsCollapsePanel("Descriptions and parameters for data preprocessing",  includeHTML("WGCNA_preprocess.html"), style = "default"),
                      bsCollapsePanel("Data Preprocessing", uiOutput('sampletree') ,
                                      br(),
           textOutput(outputId = "datacleandescrip"),  style = "default",
           br(),
           # )
            # box(
            ...
            #  bsAlert("wgcnapremess"),
            #         htmlOutput("wgcnapre"),
            #        # includeHTML("WGCNA_preprocess.html"),
            #        uiOutput('sampletree'),
            #        textOutput(outputId = "datacleandescrip"),
             ...
             fluidRow(column(4,align="left",
                             hidden(div(id = "sampletree_wrapper",
                                        splitLayout(
                                          numericInput("sampletreewidthdl","Figure width",value = 12),
                                          numericInput("sampletreeheightdl","Figure height",value = 6)),
...
fluidPage(column(9,
                 ...
                 #   align="center",
                 #   status = "success",
  bsCollapse(id = "collapseWGCNAnetwork", open = "Descriptions and parameters for data preprocessing",
            bsCollapsePanel("Descriptions and parameters for data preprocessing",  includeHTML("WGCNA_net.html"), style = "default"),
            bsCollapsePanel("Network construction and module detection", #uiOutput('sampletree') ,
                            # align = "center",
                   tabBox(
                     width=NULL,
                      # 
...
fluidPage(column(9,
                   ...
                   #   status = "success",
                   #   align="center",
    bsCollapse(id = "collapseWGCNAmtr", open = "Descriptions and parameters for data preprocessing",
        bsCollapsePanel("Descriptions and parameters for data preprocessing",  includeHTML("WGCNA_mtr.html"), style = "default"),
        bsCollapsePanel("Module-trait relationships", #uiOutput('sampletree') ,
                       ...
                       tabPanel(title="Module - trait relationships",
                                ...
                                fluidRow(column(4,align="left",
                                                hidden(div(id = "MTR_wrapper",
                                                           splitLayout(
                                                             numericInput("MTRwidthdl","Figure width",value = 6),
                                                             numericInput("MTRheightdl","Figure height",value = 6)),
                                                           downloadButton('downloadMTR', 'Download figure', class = "butt2")
                                                ))
                                ))
                                ),
                       tabPanel(title="GS vs MM",
                                value="GM",
                                align = "center",
                                uiOutput('GSplot'),
                                fluidRow(column(4,align="left",
                                                hidden(div(id = "GM_wrapper",
                                                           splitLayout(
                                                             numericInput("GMwidthdl","Figure width",value = 5),
                                                             numericInput("GMheightdl","Figure height",value = 5)),
            ...
            box(title="Module-trait relationships",
                ...
                box(title="Size control",solidHeader = F,collapsible = T,width = NULL,collapsed = T,
                  box(title="Module trait relationships",solidHeader = F,collapsible = T,width = NULL,collapsed = T,
                      sliderInput("MTRwidth", "Heatmap Width (%)", min = 0, max = 100, value = 40),
                      sliderInput("MTRheight", "Heatmap Height (px)", min = 0, max = 1000, value = 400),
                      sliderInput("BMar", "Bottom margin", min = 0, max = 20, value = 5),
                      sliderInput("LMar", "Left margin", min = 0, max = 20, value = 7),
                  ...
                  box(title="GS vs MM",solidHeader = F,collapsible = T,width = NULL,collapsed = T,
                      sliderInput("GVMwidth", "Heatmap Width (%)", min = 0, max = 100, value = 45),
                      sliderInput("GVMheight", "Heatmap Height (px)", min = 0, max = 1000, value = 450)
                  )
                ),
                actionButton("MTRbt",
                             "Submit",
