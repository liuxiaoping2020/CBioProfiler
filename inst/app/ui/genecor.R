tabItem(tabName = "gene",
        fluidRow(column(9,
          ...
          #   status = "success",
          #   align="center",
          bsCollapse(id = "collapsegene", open = "Descriptions and parameters",
                     bsCollapsePanel("Descriptions and parameters",  includeHTML("gene.html"), style = "default"),
                     bsCollapsePanel("The correlation between two genes",style = "default",
                                     
            tabBox(width = NULL,

              tabPanel(
                "Scatter plot",align="center",
                uiOutput('genecorplot'),
                useShinyjs(),
                fluidRow(column(4,align="left",
                                hidden(div(id = "genecor_wrapper",
                                          splitLayout(
                                             numericInput("genecorwidthdl","Figure width",value = 5),
                                             numericInput("genecorheightdl","Figure height",value = 5)),
              ...
              tabPanel(
                "Summary", 
                verbatimTextOutput("genecorsummary"),align="left",width = NULL,
                tags$head(
                  tags$style(
