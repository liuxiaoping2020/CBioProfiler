  ...
  fluidRow(
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "metapathplot_wrapper",
                                                                                 splitLayout(
                                                                                   ...
                                                                                   numericInput("metapathpltheight","Figure height",value = 10)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("metapathwidth", "Plot Width (%)", min = 0, max = 100, value = 60),
          sliderInput("metapathheight", "Plot Height (px)", min = 0, max = 1000, value = 800)
      ),
