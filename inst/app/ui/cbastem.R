  ...
  fluidRow(
                                             ...
                                             # tabPanel("Correlation plot", align="center",
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "cbastemnessplot_wrapper",
                                                                                 splitLayout(
                                                                                   numericInput("cbastempltwidth","Figure width",value = 10),
                                                                                   numericInput("cbastempltheight","Figure height",value = 10)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("cbastemwidth", "Plot Width (%)", min = 0, max = 100, value = 50),
          sliderInput("cbastemheight", "Plot Height (px)", min = 0, max = 1000, value = 430)
      ),
