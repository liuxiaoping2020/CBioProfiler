  ...
  fluidRow(
                                             ...
                                             tabPanel("Immune checkpoint plot", align="center",
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "cbaICBplot_wrapper",
                                                                                 splitLayout(
                                                                                   numericInput("cbaICBpltwidth","Figure width",value = 12),
                                                                                   numericInput("cbaICBpltheight","Figure height",value = 12)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("cbaICBwidth", "Plot Width (%)", min = 0, max = 100, value = 90),
