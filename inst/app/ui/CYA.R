  ...
  fluidRow(
                                             ...
                                             tabPanel("Cytotoxic activity plot", align="center",
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "CYAplot_wrapper",
                                                                                 splitLayout(
                                                                                   numericInput("CYApltwidth","Figure width",value = 5),
                                                                                   numericInput("CYApltheight","Figure height",value = 5)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("CYAwidth", "Plot Width (%)", min = 0, max = 100, value = 45),
          sliderInput("CYAheight", "Plot Height (px)", min = 0, max = 1000, value = 400)
      ),
      actionButton("CYAbt",
                   "Submit",
