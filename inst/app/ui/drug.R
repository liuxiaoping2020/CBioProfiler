  ...
  fluidRow(
                                             ...
                                             tabPanel("Drug response plot", align="center",
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "drugplot_wrapper",
                                                                                 splitLayout(
                                                                                   numericInput("drugpltwidth","Figure width",value = 5),
                                                                                   numericInput("drugpltheight","Figure height",value = 5)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("drugwidth", "Plot Width (%)", min = 0, max = 100, value = 45),
          sliderInput("drugheight", "Plot Height (px)", min = 0, max = 1000, value = 400)
      ),
      actionButton("drugbt",
                   "Submit",
