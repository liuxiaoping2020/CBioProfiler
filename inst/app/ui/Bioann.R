tabItem(
  tabName = "bioan",
               fluidRow(column(9,
                               ...
                               #   status = "success",
                               bsAlert("FEAmess"),
                               bsCollapse(id = "collapsebioan", open = "Descriptions and parameters",
                                          bsCollapsePanel("Descriptions and parameters",  includeHTML("bioann.html"), style = "default"),
                                          bsCollapsePanel("Functional enrichment analysis",style = "default",

                                 tabBox(width = NULL,
                                        tabPanel("Enrichment table",align="center", DT::dataTableOutput('enrichtable'),
                                        ...
                                        tabPanel(title="Enrichment plot",value="DEGen",align="center", uiOutput('DEGenplot'),
                                                 fluidRow(column(4,align="left",
