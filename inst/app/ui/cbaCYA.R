  ...
  fluidRow(
                                             ...
                                             tabPanel("Cytotoxic activity plot", align="center",
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "cbaCYAplot_wrapper",
                                                                                 splitLayout(
                                                                                   numericInput("cbaCYApltwidth","Figure width",value = 5),
                                                                                   numericInput("cbaCYApltheight","Figure height",value = 5)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("cbaCYAwidth", "Plot Width (%)", min = 0, max = 100, value = 45),
          sliderInput("cbaCYAheight", "Plot Height (px)", min = 0, max = 1000, value = 350)
      ),
