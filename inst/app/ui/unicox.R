tabItem(
  ...
  fluidRow(column(9,
           ...
           column(3,box(
             ...
             selectizeInput('msurvcor', "Adjusting method", choices =c("holm", "hochberg", "hommel", "bonferroni", "BH", "BY","fdr") , selected = "fdr"),
             bsTooltip("msurvcor", "Specify the correction method","left"),
             selectizeInput('msurvsel', "Significance cutoff method", choices =c("P value", "Adjusted P value","Top P value") , selected = "Adjusted P value"),
             ...
             conditionalPanel(
               condition = "input.msurvsel == 'Top P value'",
               numericInput("msurvtp","Top K Pvalue",10,min = 1,max = 10000,step =5)
             ),
