                                      ...
                                      tabPanel("Consensus matrix plot", align="center",
                                               ...
                                               fluidRow(column(4,align="left",
                                                               hidden(div(id = "cmp_wrapper",
                                                                          splitLayout(
                                                                            numericInput("cmpwidth","Figure width",value = 5),
                                                                            numericInput("cmpheight","Figure height",value = 5)),
                                               ...
                                               fluidRow(column(4,align="left",
                                                               hidden(div(id = "cdf_wrapper",
                                                                          splitLayout(
                                                                            ...
                                                                            numericInput("cdfheight","Figure height",value = 5)),
                                      ...
                                      tabPanel("Silhouette plot", align="center",
                                               ...
                                               fluidRow(column(4,align="left",
                                                               hidden(div(id = "silhouette_wrapper",
                                                                          splitLayout(
                                                                            numericInput("Silhouettewidth","Figure width",value = 5),
    ...
    column(3,
           box(
             ...
             box(title="Size control",width=NULL,solidHeader=F,collapsible=T,status=NULL,collapsed =T,
                 sliderInput("comwidth", "Consensus matrix plot Width (%)", min = 0, max = 100, value =40),
                 sliderInput("comheight", "Consensus matrix plot Height (px)", min = 0, max = 1200, value = 400),
                 sliderInput("cdfpwidth", "CDF plot Width (%)", min = 0, max = 100, value =80),
                 sliderInput("cdfpheight", "CDF plot Height (px)", min = 0, max = 1200, value = 400),
                 sliderInput("silhouettepwidth", "Silhouette plot Width (%)", min = 0, max = 100, value =40),
                 sliderInput("silhouetteppheight", "Silhouette plot Height (px)", min = 0, max = 1200, value = 400)
             ),
             actionButton("cbabt",
                          "Submit",
                          style = "background-color: #000080;
