                      ...
                      bsCollapsePanel("Time-dependent ROC analysis",style = "default",
                                      ...
                                      fluidRow(column(4,align="left",
                                                      ...
                                                      hidden(div(id = "cbasurvROC_wrapper",
                                                                 splitLayout(
                                                                   numericInput("cbasurvROCwidth.dl","Figure width",value =5 ),
                                                                   numericInput("cbasurvROCheight.dl","Figure height",value = 5)),
         ...
         column(
           ...
           box(
             ...
             box(
               ...
               collapsible = TRUE,
               collapsed = T,
               sliderInput("cbaSurvROCwidth","Plot Width (%)",min = 0,max = 100,value = 45),
               sliderInput("cbaSurvROCheight",  "Plot Height (px)",  min = 0,max = 1000,value = 350)
             ),
             useShinyjs(),
             actionButton(
               "cbaSurvROCbt",
