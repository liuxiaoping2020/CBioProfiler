tabItem(tabName = "cbaclinical",
        fluidRow(column(
          ...
          #         collapsible = F,
          #         status = "success",
          bsCollapse(id = "collapsecbaclinical", open = "Descriptions and parameters",
                     bsCollapsePanel("Descriptions and parameters",  includeHTML("cbaclinical.html"), style = "default"),
                     bsCollapsePanel("Table for the correlations between cancer subtype and clinical features",style = "default",
                                     # align="center",
                                     htmlOutput("cbaclinical1",align="center")
                     )
          )),
          column(
            3,
            box(
              title = "Correlations between cancer subtype and clinical features",
              width = NULL,
              status = "danger",
              solidHeader = T,
              collapsible = F,
              ...
              # ),
              selectizeInput(
                "cbaclinicalfeaturecohort",
                label = "Select the cohort",
                choices = c("Training set","Validation set"),
                selected="Training set",
                multiple = F
              ),
              bsTooltip("cbaclinicalfeaturecohort", "Select the cohort (training set or validation set) to characterize the subtype","left"),
              ...
              bsTooltip("cbaclinicalfeature", "Select clinical features you want to include in the table","left"),
              useShinyjs(),
              actionButton(
                "cbaclinicaltable1bt",
                "Submit",
        ...
        fluidRow(
          div(style="display:inline-block;vertical-align:middle;margin-left:15px; float: left;",
              actionButton(inputId = 'page_before_cbaclinical',label = '',icon = icon('arrow-left'),
          ...
          div(style="display:inline-block;vertical-align:middle;margin-right:15px; float: right;",
              ...
              actionButton(inputId = 'page_after_cbaclinical',label = '',icon = icon('arrow-right'),
                           style="color: #fff; background-color: #428bca; border-color: #2e6da4;")
          )
        )
