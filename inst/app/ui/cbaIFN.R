  ...
  fluidRow(
                                             ...
                                             tabPanel("Interferon-gamma score plot", align="center",
                                                      ...
                                                      fluidRow(column(4,align="left",
                                                                      hidden(div(id = "cbaIFNplot_wrapper",
                                                                                 splitLayout(
                                                                                   numericInput("cbaIFNpltwidth","Figure width",value = 5),
                                                                                   numericInput("cbaIFNpltheight","Figure height",value = 5)),
    ...
    column(3,box(
      ...
      box(title = "Size control",width = NULL,
          ...
          sliderInput("cbaIFNwidth", "Plot Width (%)", min = 0, max = 100, value = 45),
          sliderInput("cbaIFNheight", "Plot Height (px)", min = 0, max = 1000, value = 350)
      ),
