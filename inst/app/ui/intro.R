...
tabItem(
  ...
  fluidRow(column(
    ...
    p("The user gudie for CBioExplorer can be found "
      , a("here.", href="https://github.com/liuxiaoping2020/CBioExplorer/blob/main/CBioExplorer%20user%20guide.pdf")
      , style="padding-left: 0em"),
    p("If you have questions to raise or are experiencing difficulties using the CBioExplorer, please go to "
      , a("CBioExplorer Github issues.", href="https://github.com/liuxiaoping2020/CBioExplorer/issues")
      , style="padding-left: 0em"),

    h3("Contact"),
    p("This Web app is developed and maintained by Xiao-Ping Liu at Xing-Huan Wang's Lab, Department of Urology, Zhongnan hospital of WUhan University"),
