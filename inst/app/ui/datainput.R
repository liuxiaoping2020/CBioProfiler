tabItem(tabName = "dataset",
         ...
         fluidRow(
          column(9,
                 ...
                 bsAlert("inputmess"),
                 bsCollapse(id = "collapsedatainput", open = "Descriptions and parameters for data input",
                            bsCollapsePanel("Descriptions and parameters for data input",  includeHTML("datainput.html"), style = "default"),
                            bsCollapsePanel("Overview of discovery set",style = "default",
                                            # uiOutput('sampletree') ,
                                            # textOutput(outputId = "datacleandescrip"),  
                 
              # box(
              # title="Overview of discovery set",width = NULL,
...
###################################################################################################################
        ...
        fluidRow(
          column(9,
                 # box(
                 #   title="Overview of external validation set",width = NULL,
                 #   solidHeader=T,collapsible=T,collapsed=F,status="success",
...
#          # extendShinyjs(text = "shinyjs.reset = function() {history.go(0)}" , functions = "reset"),
#          actionButton("reset_button",
#                       "Restart CBioExplorer",
#                       type="success",
#                       style = "background-color: #000080;
#                                             color: floralwhite;
#                                             margin-left: auto;
