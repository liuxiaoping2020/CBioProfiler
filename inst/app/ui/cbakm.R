tabItem(tabName = "cbaKM",
                                                   ...
                                                   fluidRow(column(4,align="left",
                                                                   ...
                                                                   hidden(div(id = "cbakm_wrapper",
                                                                              ...
                                                                              splitLayout(
                                                                                ...
                                                                                numericInput("cbakmwidth","Figure width",value = 5),
                                                                                numericInput("cbakmheight","Figure height",value = 5)),
        ...
        column(3,box(
          ...
          box(title="Size control",width=NULL,solidHeader=F,collapsible=T,status=NULL,collapsed =T,
              sliderInput("cbasurvwidth", "Plot Width (%)", min = 0, max = 100, value =45),
              sliderInput("cbasurvheight", "Plot Height (px)", min = 0, max = 1200, value = 400),
